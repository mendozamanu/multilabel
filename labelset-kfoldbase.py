#Script para clasificar los datasets grandes, particionados mediante 10-fold y labelsets
...
if len(sys.argv) <= 1:
    print "Correct use: multilabelKfold.py input-file [test indicator]"
    sys.exit()
...
for cl in classifier:
    ...
    if not os.path.exists("./csv/"):
        os.makedirs("./csv/")
    if act==1:
        fname='./csv/'+str(cl).split('(')[0]+'-'+str(pr)+'_labelset.csv'
    else:
        fname='./csv/'+str(cl).split('(')[0]+'_labelset.csv'
